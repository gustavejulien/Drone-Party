...
class MasterApiToutou:
    def __init__(self):
        pass

    def init_tests(self):
        self.urls = {
            "start": "http://localhost:8001/toutou/start/",
            "active": "http://localhost:8001/toutou/active/",
            "desactive": "http://localhost:8001/toutou/desactive/",
            "destroy": "http://localhost:8001/toutou/destroy/",
